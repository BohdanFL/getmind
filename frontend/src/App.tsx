  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100 p-6 md:p-8 flex flex-col font-sans selection:bg-neon-blue/30 overflow-hidden relative">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-[-15%] right-[-5%] w-[50%] h-[50%] bg-electric-violet/5 rounded-full blur-[140px] animate-pulse" style={{ animationDelay: '1s' }} />
      </div>
      ...
      <header className="max-w-[1600px] w-full mx-auto mb-8 flex shrink-0 items-start justify-between relative z-10">
        <div className="flex flex-col">
          ...
          <div className="flex items-center space-x-3">
            <Badge variant="outline" className="px-2 py-0.5 bg-slate-900/50 border-slate-800 text-[10px] font-mono text-slate-400">
          ...
          <Card className="h-32 glass-card rounded-2xl p-5 border-slate-800/20 relative overflow-hidden">
             ...
             <div className="relative z-10">
                <div className="flex justify-between items-center mb-3">
                  <h4 className="text-[10px] uppercase font-bold tracking-widest text-slate-500">Retrieval Strength (SRS)</h4>
                  <Badge variant="outline" className="text-[9px] h-4 border-blue-500/30 text-blue-400 font-mono">
                    OPTIMAL
                  </Badge>
                </div>
                <Progress value={45} className="h-1.5 bg-slate-800/50 overflow-hidden" />
